<template>
  <div class="pay_container">
    <div class="name">嵌贝鹿形青铜镇参观活动</div>
    <div class="info">
      <div class="price"><span>500</span>元</div>
    ...
    <div class="form">
      ...
      <div class="warn conpu">
        <span>优惠券</span>
        <span  class="edit" @click="edit">5张可用  <van-icon style="vertical-align:middle;" name="arrow" /></span>
      </div>
    </div>
    <form @submit="goPay" report-submit="true">
      <button form-type="submit" :style="isEdit? 'background:#ccc;':''" class="pay">支付报名活动费</button>
    </form>
